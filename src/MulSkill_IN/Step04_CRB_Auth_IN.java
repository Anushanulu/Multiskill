...
public class Step04_CRB_Auth_IN {
  ...
  @FindBy ( xpath=".//*[@id='body']/div[1]/div[2]/div/div/form/input[4]") private WebElement Password_Box ;
	...
	// Define all web elements under test displayed on home page
		...
		@FindBy (xpath= ".//*[@id='content-main']/form/table[6]/tbody/tr[2]/td[5]/a") private WebElement service_identification1;
    ...
    public void reqs()
    {
		...
		wait07.until(ExpectedConditions.visibilityOf(service_identification1));
		service_identification1.click();
		servreq();
