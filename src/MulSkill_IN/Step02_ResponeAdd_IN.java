...
public class Step02_ResponeAdd_IN
{
	...
	@FindBy (xpath = "//input[@id='checkBoxId-002-0']/parent::label[@class='container']/span[@class='checkmark']") private WebElement Resp2_Checkbox;
	...
	//@FindBy (xpath = "//*[@id='mat-expansion-panel-header-9']/span[1]/mat-panel-title/span[1]") private WebElement Skill2;
	//@FindBy (xpath = "(//mat-panel-title[@class='mat-expansion-panel-header-title'])[4]") private WebElement Skill2;
	//@FindBy (xpath = "//span[contains(text(),'Skill 002 : Application Developer')]") private WebElement Skill2;
	@FindBy (xpath = "(//button[@ibmbutton='secondary' and contains(text(),'Submit')])[2]") private WebElement Submit_Button2;
	
	@FindBy (xpath ="//span[@class='headerTitle' and contains(text(),'Skill 002')]") private WebElement Skill2;



	// Initialize the web elements 
	public Step02_ResponeAdd_IN (WebDriver driver)
	{
		this.driver=driver;
	...
	public void login(){
		...
		if (ContinueButton.isDisplayed())
		{
			...
			//UsernameField.clear();
			UsernameField.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 12, 0));
			...
			PasswordField.clear();
			PasswordField.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 12, 1));
	...
	public void openRequest() throws InterruptedException
	{
		...
		System.out.println("searched and Opened the request "+Excel.getCellValue(xlsFilePath, "Request_creation", 3, 15));
	...
	//Add Response and details
	public void FillRespdetails(String skill,String First_Name_temp , String Middle_Name_temp , String LastName_Surname_temp, String citizenship , String rate, String wage, String Refernce_Num ) throws IOException, InterruptedException 
	{
		//String skill = "Skill 002";
	WebElement btn_Add_response1 = driver.findElement(By.xpath("//span[contains(text(),'"+skill+"')]//ancestor::div[@class='accordion-container ng-star-inserted']//button[text()='Add Response']"));
			waitForFormOverlayDisappear();
		WebDriverWait wait6 = new WebDriverWait(driver, 160);
		wait6.until(ExpectedConditions.elementToBeClickable(btn_Add_response1));

		/*Taking screenshot */
		/*Screenshots shot=new Screenshots(driver);
		shot.ScreenShot_EXPCore_US();*/
//Thread.sleep(3000);
		btn_Add_response1.click();
		...
		Thread.sleep(500);
		String AttachmentPath = System.getProperty("user.dir") + "\\src\\testdata\\test.txt";
...
/*		WebDriverWait wait7 = new WebDriverWait(driver, 160);
	...
	public void skill2() throws InterruptedException
	{
		...
		wait00.until(ExpectedConditions.visibilityOf(Skill2));*/
	...
	public void Submit2() throws InterruptedException
	{
		...
		isloadComplete(driver);
		WebDriverWait wait0 = new WebDriverWait(driver, 500);
		wait0.until(ExpectedConditions.visibilityOf(Resp2_Checkbox));

		JavascriptExecutor executor = (JavascriptExecutor)driver;
		executor.executeScript("arguments[0].click();", Resp2_Checkbox);
		
		WebDriverWait wait1 = new WebDriverWait(driver, 160);
		wait1.until(ExpectedConditions.elementToBeClickable(Submit_Button2));
		Thread.sleep(500);
	
		executor.executeScript("arguments[0].click();", Submit_Button2);
