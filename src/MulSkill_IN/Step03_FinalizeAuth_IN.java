...
@FindBy ( xpath = ".//*[@id='content-main']/form/table[4]/tbody/tr[1]/td[3]/a" ) private WebElement Requested_Skill2 ;
...
public void skill2()
{
	...
	searchReq();
	WebDriverWait wait2 = new WebDriverWait(driver, 160);
	wait2.until(ExpectedConditions.visibilityOf(Requested_Skill2)); 
	Requested_Skill2.click();
